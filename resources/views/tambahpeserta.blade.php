...
@section('content')
  <h1 class="my-3 text-center bg-success text-white py-3 rounded-3 border border-dark">Tambah Peserta</h1>
    ...
    <div class="card-body m-3 text-white rounded" style="background: rgba(0, 0, 0, 0.9)">
      <form action="/insertpeserta" method="POST">
        ...
        <div class="mb-3">
          ...
          <input type="text" name="nama_lengkap" class="form-control @error('nama_lengkap') is-invalid @enderror" id="nama_lengkap" aria-describedby="nama_lengkap" value="{{ old('nama_lengkap') }}">
          @error('nama_lengkap')
        ...
        <div class="mb-3">
          ...
          <input type="number" name="nilai_x" class="form-control @error('nilai_x') is-invalid @enderror" id="nilai_x" value="{{ old('nilai_x') }}">
          @error('nilai_x')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
        ...
        <div class="mb-3">
          ...
          <input type="number" name="nilai_y" class="form-control @error('nilai_y') is-invalid @enderror" id="nilai_y" value="{{ old('nilai_y') }}">
          @error('nilai_y')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
        ...
        <div class="mb-3">
          ...
          <input type="number" name="nilai_z" class="form-control @error('nilai_z') is-invalid @enderror" id="nilai_z" value="{{ old('nilai_z') }}">
          @error('nilai_z')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
        ...
        <div class="mb-3">
          ...
          <input type="number" name="nilai_w" class="form-control @error('nilai_w') is-invalid @enderror" id="nilai_w" value="{{ old('nilai_w') }}">
          @error('nilai_w')
            <div class="invalid-feedback">
              {{ $message }}
            </div>
